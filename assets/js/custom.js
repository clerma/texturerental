...
08. sc-services 1 owlCarousel
09. sc-services Page owlCarousel
...
$(function () {
    ...
    // sc-services owlCarousel *
    $('.sc-service .owl-carousel').owlCarousel({
        loop: true,
        margin: 30,
        mouseDrag: true,
        autoplay: false,
...
$(document).ready(function () {
    ...
    owl.on('changed.owl.carousel', function (event) {
        ...
        $('.btn-light').removeClass('animated fadeInUp');
        $('.btn-dark').removeClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('span').addClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('h4').addClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('h1').addClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('p').addClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('.btn-light').addClass('animated fadeInUp');
        $('.owl-item').not('.cloned').eq(item).find('.btn-dark').addClass('animated fadeInUp');
    });
});
